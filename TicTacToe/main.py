...
def continue_play():
    ...
    continue_answer= input('Continue Game? Y or N\n ')
    if continue_answer not in ('n', 'N'):
        pass
    else:
        replay()
...
#Game Startup
    ...
    """
    To fix:
    using non y or other letters == y
    persudocode
    ask to continue everymove - it now gots to replay but replay doesnt work
